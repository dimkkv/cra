...
import MyModal from './headless-modal';
import HeadlessAddAlert from './headless-modal-add-alert';
...
function TableHeader() {
  return (
    <>
      ...
      <div className='grid grid-cols-1 xl:grid-cols-2 xl:justify-start justify-center gap-4 items-center text-center xl:text-left pb-8'>
        <div>
          {/*  */}
          <MyModal />
        </div>
